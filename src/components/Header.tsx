              ...
              >
                {item.submenu ? (
                  <button
                    ...
                    className={`px-2 xl:px-3 2xl:px-4 py-2 text-[11px] xl:text-xs 2xl:text-sm font-semibold rounded-lg transition-all duration-300 relative overflow-hidden group text-center leading-tight ${
                      isActive
